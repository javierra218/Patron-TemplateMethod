...
public class GUIPanelOpciones extends javax.swing.JFrame {
    ...
    RestaurantService servicioRestaurante;
    IRestaurantAccess serviceRes;
     IPlateAccess servicePl;
    public GUIPanelOpciones() {
        ...
        this.setIconImage(icon);
         serviceRes=Factory.getInstance().getsRestaurantSerive();
        servicePl=Factory.getInstance().getDishService();
         servicioRestaurante=new RestaurantService(serviceRes);
        servicioPlato=new PlateService(servicePl);
    ...
    private void initComponents() {
        ...
        MIAgregarComp = new javax.swing.JMenuItem();
        ...
        MIAgregarComp.setText("Agregar Componente");
        MIAgregarComp.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MIAgregarCompActionPerformed(evt);
            }
        });
        mnuPaqueteTodoIncluido.add(MIAgregarComp);

        jMenuItem1.setText("Listar Componentes");
        ...
        mnuPaqueteTodoIncluido.add(mnuConfiguracionTarifas);
    ...
    private void MIAgregarCompActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MIAgregarCompActionPerformed
        // TODO add your handling code here:
        GUIPlate plate = new GUIPlate(servicioPlato);
        plate.setMaximizable(true);
        
        dskEscritorio.add(plate);
        plate.show();
    }//GEN-LAST:event_MIAgregarCompActionPerformed

    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
       GUIListaComponente componentes = new GUIListaComponente(servicioPlato);
        componentes.setMaximizable(true);
        
        dskEscritorio.add(componentes);
        componentes.show();
    ...
    private javax.swing.JMenuItem MIAgregarComp;
